...
class _FormMahasiswaPageState extends State<FormMahasiswaPage> {
  ...
  void _simpan() {
    ...
    if (selectedFakultas == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Fakultas belum dipilih')),
      );
      return;
    }
    if (selectedProdi == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Program studi belum dipilih')),
      );
      return;
    }
    if (tglLahir == null) {
        ...
        content: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                DropdownMenuItem(value: "Ilmu Komputer", child: Text("Ilmu Komputer")),
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(value: "Manajemen", child: Text("Manajemen")),
              ],
